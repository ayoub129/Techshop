...
<div class="row">
    ...
    <div class="rounded  py-5  row align-items-center ">
        <div class="col-5 bg-light bg-gradient">
            <?php 
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ?>
                        <img src="<?php echo $row['src'] ?>" alt="" class="img-fluid w-100">
                <?php } ?>
        </div>
        <div class="col-6 ms-5">
             <?php 
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ?>
                        <h1 class="fs-big fw-bold"><?php echo $row['name'] ?></h1>
                        <p class="fs-14 my-4 text-muted"><?php echo $row['description'] ?></p>
                <?php } ?>
        </div>    
       </div>
       <hr>
        <h1 class="fs-1 text-center">Choose the best deal for You </h1>
        <div class="row align-items-center mt-5">
            <?php 
                 $id = $_GET['id'];
                $sql = "SELECT * FROM product WHERE category_id = '$id' ORDER BY id DESC LIMIT 0,16";
                $result = mysqli_query($conn , $sql);
                while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="col-4">
                    <div class="card p-2 position-relative">
    ...
    <section class="row align-items-center justify-content-between mt-5">
        ...
        ?>
        <div class="col-4">
            <h2 class="fs-3">Search Other Categories</h2>
            <div class="card text-white w-100 ">
                ...
                <div class="card-img-overlay bg-danger-opacity-8 ">
                    ...
                    <a href="category.php" class="card-text decoration-none fw-bold text-white text-uppercase mx-5 my-3">
